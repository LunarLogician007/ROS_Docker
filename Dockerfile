...
####################
RUN git clone https://github.com/LunarLogician007/ROS_MAC_OS.git -b add_clipboard_support /usr/lib/novnc
...
RUN echo '[supervisord]' >> $CONF_PATH \
    ...
    && echo 'command=gosu '$USER' /opt/TurboVNC/bin/vncserver :0 -fg -wm xfce -geometry 1920x1080 -depth 24' >> $CONF_PATH \
